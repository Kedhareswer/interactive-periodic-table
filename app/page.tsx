    ...
    <main className="min-h-screen bg-gradient-to-b from-amber-50 to-amber-100 dark:from-slate-950 dark:to-slate-900">
      <div className="container mx-auto px-4 py-8">
        <header className="mb-8 text-center">
          <h1 className="font-serif text-4xl font-bold text-amber-900 dark:text-amber-500 md:text-5xl lg:text-6xl">
            तत्त्व चक्र
          </h1>
          <p className="mt-2 text-xl text-amber-800 dark:text-amber-400">The Periodic Table of Elements</p>
          <div className="mx-auto mt-6 max-w-3xl rounded-lg border border-amber-200 bg-amber-50/50 p-4 text-left dark:border-amber-900/30 dark:bg-amber-900/10">
